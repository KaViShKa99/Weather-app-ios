...
//    @Published var apiKey = "3445686f5532f708008346a0d50225bc"
    private var apiKey = "6c1ad75e478ac43e1372891f40ed9397" //my api key
    ...
    func loadLocationsFromJSONFile(cityName: String) -> [Location]? {
        if let fileURL = Bundle.main.url(forResource: "places", withExtension: "json") {
            do {
                ...
                let filteredLocations = allLocations.filter { $0.cityName.lowercased() == cityName.lowercased() }
